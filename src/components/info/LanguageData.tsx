...
export default function LanguageData() {
    ...
    return (
        <div
            className={c(
                "transition-all w-full sm:!w-128 h-fit",
                selected === null ? "rounded-t-lg" : "rounded-lg",
            )}
            ref={containerRef}
        >
            <div className="bg-gradient-to-b from-slate-900 to-slate-950 rounded-t-lg">
                {hintShown && (
                    <Icon
                        ...
                        (k, i) => (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        backgroundColor: languages[k].colour,
                                    }}
                                />
            ...
            <div
                className={c(
                    "w-full transition-all overflow-y-auto overflow-x-none bg-slate-950 rounded-b-lg",
                    selected ? "h-44" : "h-0",
                )}
            >
                {selected && (
                    <div className="text-gray-400 p-2 content-spaced">
